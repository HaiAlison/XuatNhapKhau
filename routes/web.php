...
=======
			...
			Route::post('/store-shipment','User\ShipmentController@store')->name('store-shipment');


			Route::get('/payment-overseas','User\PaymentOverseaContrller@create')->name('payment-overseas');
			Route::post('/show-payment-overseas','User\PaymentOverseaContrller@show')->name('show-payment-overseas');
			Route::get('/export','User\PaymentOverseaContrller@export')->name('export');
			Route::get('/create-payment-overseas/{po_no_id}/{sub_po_id}','User\PaymentOverseaContrller@create_id')->name('create-payment-overseas');
...
=======
			...
			Route::get('/shipment','User\ShipmentController@index')->name('admin-shipment');
			Route::get('/create-shipment','User\ShipmentController@create')->name('create-shipment');
			Route::get('/shipment/edit/{po_no_id}/{sub_po_id}','User\ShipmentController@edit')->name('edit-shipment');
			//Route account
