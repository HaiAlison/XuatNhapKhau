  ...
  <div class="form-group row">
    ...
    <div class="col-sm-6">
      <div class="input-group">
        ...
        <div class="custom-file">
          <input type="file" class="custom-file-input" name="link_to_specs" id="inputGroupFile01" accept=".jpg,.png,.bmp,.pdf,.txt,.xlsx,.docs,.doc,.xls" 
                          ...
                          <div class="form-group row ">\
                            <div class="col-sm-6">\
                              <div class="input-group">\
                                ...
                                <div class="custom-file">\
                                  <select class="custom-select changeId product" id="product0" name="product_code_id[]" onchange="NullProduct(this)">\
