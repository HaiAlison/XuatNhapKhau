              ...
              <tbody id="add-row">
                <tr>
                  <td class="product-thumbnail">
                    <select class="custom-select width-select"  id="product_id" name="product_code_id[]"> 
                  ...
                  <td class="product-subtotal">
                      <div class="col-sm-12">
                        <input type="text" id="net_weight_id" name="net_weight_id[]" step=".01" class="form-control form-control-md" placeholder="" >
                      </div>
                    </td>
                    <td class="product-subtotal">
                      <div class="col-sm-12">
                        <input type="text" id="price" step=".01" name="price[]" class="form-control custom-input">
                      </div>
                    </td>
                    <td class="product-subtotal" onkeydown="addRow()">
                      <div class="col-sm-12">
                        <input type="text" id="total_amount" placeholder="" step=".01" name="total_amount[]" class="form-control form-control-md" readonly="">
                      </div>
                    </td>
                </tr>
              </tbody>
    ...
    function addRow(){
        ...
        if(eventwhich == 9){
          ...
          table.append('  <tr>\
            ...
            <td class="product-subtotal">\
            <div class="col-sm-12">\
            <input type="text" id="net_weight0" name="net_weight_id[]" step=".01" class="form-control form-control-md changeId" placeholder="" disabled>\
            </div>\
            </td>\
            <td class="product-subtotal">\
            <div class="col-sm-12">\
