...
@section('content')
<form action="{{ route('admin.update-shipment',['po_no_id'=>$shipments->po_no_id,'id'=> $shipments->sub_po_id]) }}" method="post">
    @csrf
    ...
    <div class="row">
        <div class="col-lg-6 col-md-12">
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="po_no_id" id="po_no_id" class="form-control form-control-sm" placeholder=""
                        value="{{$shipments->po_no_id}}">
                </div>
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control form-control-sm" name="sale_contract_no"
                        id="sale_contract_no" value="{{$shipments->sale_contract_no}}" placeholder="">
                </div>
                <label class="col-sm-4 col-form-label" for="InvoiceNo">Invoice No.</label>
                <div class="col-sm-8">
                    <input type="text" id="invoice_no" class="form-control form-control-sm" name="invoice_no"
                        value="{{$shipments->invoice_no}}" placeholder="">
                </div>
                ...
                <div class="col-sm-8">
                    <input type="text" name="vessel_name" class="form-control form-control-sm" id="vessel_name"
                        value="{{$shipments->vessel_name}}" placeholder="">
                </div>
                ...
                <div class="col-sm-8">
                    <select name="shipment_status_id" class="form-control form-control-sm" id="shipment_status_id">
                        ...
                        <option @if($pod->id==$shipments->shipment_status_id) selectted @endif
                            value="{{$pod->id}}">{{$pod->shipment_status}}</option>
                        @endforeach
                        @endif
                    </select>
                </div>
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control form-control-sm" id="incoterms_id" placeholder=""
                        @if(isset($incotermList)) @foreach($incotermList as $incoterm)
                    ...
                    <input type="hidden" name="incoterms_id" id="incoterms_id" placeholder="" @if(isset($incotermList))
                        @foreach($incotermList as $incoterm) @if(isset($shipments)&&
                        $shipments->incoterms_id==$incoterm->id)
                    value="{{$incoterm->id}}"
                    @endif
                    @endforeach
                    @endif readonly />
        ...
        <div class="col-lg-6 col-md-6">
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control form-control-sm" name="gross_weight" id="gross_weight"
                        value="{{$shipments->gross_weight}}" placeholder="">
                </div>
